        ...
        switch (choose) {
            case 1: {
                ...
                if (isLogin) {
                    ...
                    BookingServiceController useSerivceController = new BookingServiceController();
                        ...
                        case 4: {
                            ...
                            switch (chooseCus) {
                                ...
                                case 3: {
                                    ...
                                    if (updatedCus) {
                                        System.out.println("Chỉnh sửa khách hàng mã " + codeCustomer + " thành công");
                                    } else {
                                ...
                                case 4: {
                                    ...
                                    if (searchCustomer == null) {
                                        System.out.println("Không tìm thầy khách hàng hãy thử gửi lại mã khách hàng");
                                    } else {
                            ...
                            switch (choosePlaceRoom) {
                                ...
                                case 4: {
                                    ...
                                    if (checkout) {
                                        ...
                                        // Lễ tân nhận thấy đủ điều kiện để áp dụng mã giảm giá vào đơn hàng có thể hỏi
                                        //
                                        ...
                                        Boolean checkedPayment = paymentController.createPayment(bookingSelect.getId(),
                                                amount, "Cash");
                                        if (!checkedPayment) {
